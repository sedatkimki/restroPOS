          ...
          <>
            <div className="flex gap-3">
              {selectedFile ? (
                ...
                <div className="flex min-h-20 min-w-20 flex-wrap content-center justify-center rounded-md border shadow-sm">
                  <ImageOff className="h-6 w-6 flex-1   text-neutral-300" />
                </div>
              )}
              <FormField
                control={form.control}
